...
/**
 * Created by Ashley Wong on 16/11/2016.
 */
 ...
 abstract public class Sprite {
  ...
  public boolean collideWith(Sprite Stone) {
        return collideWith(Stone.getBounds(), Stone.getBitmap());
    }
 ...
 public boolean collideWith(Rect bounds, Bitmap bitmap) {
       return CollisiondetectionActivity.collidePixel(getBounds(), bounds, getBitmap(), bitmap);
    }
